...
<!--[if (gte IE 9)|!(IE)]><!-->
<script src="${pageContext.request.contextPath }/static/lib/assets/js/jquery-3.3.1.min.js"></script>
<!--<![endif]-->
<!--[if lte IE 8 ]>
...
<script src="${pageContext.request.contextPath }/static/lib/assets/js/app.js"></script>