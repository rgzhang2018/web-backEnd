...
Blockly.JavaScript['movepx2'] = function (block) {
    // TODO: Assemble JavaScript into code variable.
		var move_direction=block.getFieldValue('moveDirection');
		var value_pixel = Blockly.JavaScript.valueToCode(block, 'pixelNumber', Blockly.JavaScript.ORDER_ATOMIC);
		var code ="movepx2(\""+move_direction+"\","+value_pixel+");\n";
		//var code='movepx("move_direction",pixel_number);\n';
    return code;
};
...
Blockly.JavaScript['turn2'] = function (block) {
    ...
    // TODO: Assemble JavaScript into code variable.
    var code = "turn2(\"" + dropdown_turndire + "\" ," + value_degree + ");\n";
    return code;
};
Blockly.JavaScript['jump'] = function(block) {
  var dropdown_jumpdirection = block.getFieldValue('jumpDirection');
  var value_pixel = Blockly.JavaScript.valueToCode(block, 'pixel', Blockly.JavaScript.ORDER_ATOMIC);
  // TODO: Assemble JavaScript into code variable.
  var code = "jump(\""+dropdown_jumpdirection+"\","+value_pixel+");\n";
  return code;
};
